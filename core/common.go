...
func applyConfig(params *SetupParams) error {
        // S-10: Removed explicit runtime.GC() - Go's incremental GC handles this automatically.
        // The stop-the-world GC spike caused unnecessary CPU usage during profile switching.
        runLock.Lock()
        defer runLock.Unlock()
        var err error
